...
class AdiantiTemplateParser
{
    ...
    public static function parse($content)
    {
        ...
        $content = str_replace('{ENVIRONMENTCOLOR}', self::definirCorAmbiente(), $content);
    ...
    private static function definirCorAmbiente(){
        $ambiente = new AmbienteConexao();
        return $ambiente->verificarProducao() ? 'blue' : 'red';
    }
