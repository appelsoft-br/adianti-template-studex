...
class SystemMessageList extends TStandardList
{
    ...
    public function filterInbox($param)
    {
        ...
        $criteria->add(new TFilter('system_user_to_id', '=', SessaoService::buscarIdUsuarioLogado()));
    ...
    {
        $criteria = new TCriteria;
        $criteria->add(new TFilter('system_user_id', '=', SessaoService::buscarIdUsuarioLogado()));
        TSession::setValue('inbox_criteria', $criteria);
