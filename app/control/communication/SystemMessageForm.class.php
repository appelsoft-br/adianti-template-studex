...
class SystemMessageForm extends TWindow
{
    ...
    function __construct()
    {
        ...
        $system_user_to_id = new TDBMultiSearch('system_user_to_id', 'sample', 'SystemUser', 'id', 'name');
        ...
        $this->form->addQuickAction(_t('Send'), new TAction(array($this, 'onSend')), 'far:envelope');
