...
class SystemMessageFormView extends TPage
{
        ...
        try {
            ...
            if (isset($data->id)) {
                ...
                if ($object) {
                    ...
                    if ($object->system_user_to_id == SessaoService::buscarIdUsuarioLogado() or $object->system_user_id == SessaoService::buscarIdUsuarioLogado()) {
                        ...
                        if ($object->system_user_to_id == SessaoService::buscarIdUsuarioLogado()) {
                            if ($object->checked == 'N') {
    ...
    public function onCheck($param)
    {
        try {
            ...
            if ($message) {
                if ($message->system_user_to_id == SessaoService::buscarIdUsuarioLogado()) {
                    $message->checked = 'Y';
                    $message->store();
