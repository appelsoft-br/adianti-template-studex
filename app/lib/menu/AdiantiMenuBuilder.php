    ...
    public static function parse($file, $theme)
    {
        ...
        switch ($theme)
        {
            case 'theme3':
                ...
                $menu = new TMenu($xml, self::CHECK_PERMISSION, 1, 'treeview-menu', 'treeview', '');
            ...
            default:
                ob_start();
                $xml = new SimpleXMLElement(file_get_contents($file));
                $menu = new TMenu($xml, self::CHECK_PERMISSION, 1, 'ml-menu', 'x', 'menu-toggle waves-effect waves-block');
